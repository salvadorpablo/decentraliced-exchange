...
contract('Dex', (accounts) => {
    ...
    it('1. Should deposit tokens', async () => {
    ...
    it('2. Should not deposit tokens if token does not exists', async () => {
        await expectRevert(
            dex.deposit(
    ...
    it('3. Should withdraw tokens', async () => {
        const amount = web3.utils.toWei('100');
    ...
    it('4. Should NOT withdraw tokens if token does not exist', async () => {
        await expectRevert(
            dex.withdraw(
                web3.utils.toWei('100'),
    ...
    it('5. Should NOT withdraw tokens if balance is too low', async () => {
        await dex.deposit(
            web3.utils.toWei('100'),
            DAI,
            { from: trader1 }
    ...
    it('7. Should NOT create limit order if token does not exist', async () => {
        await expectRevert(
    ...
    it('8. Should NOT create limit order if token is DAI', async () => {
        await expectRevert(
            dex.createLimitOrder(
                DAI,
                web3.utils.toWei('1000'),
    ...
    it('9. Should NOT create limit order if token balance is too low', async () => {
        await dex.deposit(
            web3.utils.toWei('99'),
            REP,
            { from: trader1 }
    ...
    it('10. Should NOT create limit order if DAI balance too low', async () => {
        await dex.deposit(
            web3.utils.toWei('99'),
            DAI,
            { from: trader1 }
    ...
    it('12. Should NOT create market order if token does not exist', async () => {
        await expectRevert(
    ...
    it('13. Should NOT create market order if token is DAI', async () => {
        await expectRevert(
            dex.createMarketOrder(
                DAI,
                web3.utils.toWei('1000'),
    ...
    it('14. Should NOT create market order if token balance is too low', async () => {
        await dex.deposit(
            web3.utils.toWei('99'),
            REP,
            { from: trader1 }
    ...
    it('15. Should NOT create market order if DAI balance too low', async () => {
        await dex.deposit(
            web3.utils.toWei('100'),
            REP,
            { from: trader1 }
    ...
    // it.only('16. Seed faucet addresses with tokens to test', async () => {
    //     console.log("hola jaja menudo atasco");
    // });
});